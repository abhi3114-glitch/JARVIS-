...
for i in range(3):  # giving 3 chances to user to give correct pass
    ...
    pw_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "password.txt")
...
def play_music():
    music_folder = r"C:\music"  # Update this with the path to your music folder
        ...
        if "wake up" in query:
            ...
            while True:
              ...
              ####################################################################
                    ...
                    pw_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "password.txt")
                    with open(pw_path, "w") as new_password:
                    ...
                    speak("My developer is abhishek. He created me to assist with various tasks and make life easier.")
                ...
                elif "open by search" in query:   #EASY METHOD
                    query = query.replace("open by search","")
                    query = query.replace("jarvis","")
                ...
                ############################################################
                    ...
                    b = random.choice(a)
                    if b==1:
                        webbrowser.open("https://youtu.be/8UjuVi_-dvc?si=mwZNt9JrSvuivOCk")
